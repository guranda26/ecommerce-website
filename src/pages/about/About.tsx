    ...
    <>
      <section className="team-section">
          ...
          <div className="team-member">
              <img src={about_SabohatS} alt="Sabohat Sobirova" className="team-photo" />
              <div className="team-info">
                  <h3>Sabohat Sobirova</h3>
                  <p className="role">Frontend Developer</p>
                  <p className="bio">I am Front-end developer with a strong foundation in web development. I am a fast learner and always eager to expand my knowledge and skills in front-end development. As for listing my top skills, I can name the followings: hard working, attentive to details. I am a team player with good problem-solving skills and a strong work ethic</p>
                  <a href="https://github.com/Sabohatfrontend" className="github-link" target="_blank">GitHub Profile</a>
              </div>
          </div>
          <div className="team-member">
              <img src={about_GurandaL} alt="Guranda Lemonjava" className="team-photo" />
              <div className="team-info">
                  <h3>Guranda Lemonjava</h3>
                  <p className="role">Frontend Developer</p>
                  <p className="bio">Hello! I am Guranda, a Junior Frontend Developer with a passion for user-centric experiences in React. I&apos;m also building my skills in backend (Node.js, Express, MongoDB) and cloud (SAP CAP) to grasp data flow and explore cloud options. This lets me collaborate seamlessly and build adaptable apps.</p>
                  <a href="https://github.com/guranda26" className="github-link" target="_blank">GitHub Profile</a>
              </div>
          </div>
          <div className="team-member">
              <img src={about_InaFK} alt="Ina Flaryanovich-Kukharava" className="team-photo" />
              <div className="team-info">
                  <h3>Ina Flaryanovich-Kukharava</h3>
                  <p className="role">Frontend Developer</p>
                  <p className="bio">I am a UI Master in transforming designs into dynamic web pages. My portfolio spans e-commerce, e-learning, beauty, handmade, and internal company sites, handling both support for existing projects and full redesigns or new design implementation from scratch.
                                      I have successfully collaborated with teams of various sizes, following Agile methodologies.
                                      Currently, I am enhancing my skills through a course focused on JavaScript and related technologies such as React.js, TypeScript</p>
                  <a href="https://github.com/inafk" className="github-link" target="_blank">GitHub Profile</a>
              </div>
          </div>
      </section>
